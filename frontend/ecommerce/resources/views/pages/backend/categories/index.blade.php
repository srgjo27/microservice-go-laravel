...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">
            <a href="{{ route('backend.categories.index') }}" class="text-white">Categories</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">All Categories</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <!--begin::Add Category-->
                <a href="{{ route('backend.categories.create') }}" class="btn btn-primary" id="kt_toolbar_primary_button">
                    Add Category
                </a>
                <!--end::Add Category-->
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <span class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                                data-category-filter="category_name">{{ $category->name }}</a>
                                                <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="javascript:;" class="btn btn-sm btn-danger"
                                            onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','DELETE','{{ route('backend.categories.destroy', $category->ID) }}');">
