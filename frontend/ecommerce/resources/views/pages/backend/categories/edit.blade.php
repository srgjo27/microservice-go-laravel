...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">Edit Category</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('content')
    <form id="form_input" class="form d-flex flex-column flex-lg-row"
        data-kt-redirect="{{ route('backend.categories.index') }}"
        action="{{ route('backend.categories.update', $category->ID) }}" method="PUT">
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Editor-->
                        <div id="description" name="description" class="min-h-200px mb-2">{!! $category->description !!}</div>
